...
require_once PATH_THIRD .'publisher/models/publisher_site_pages.php';

class Test_publisher_site_pages extends Testee_unit_test_case {
   ...
   * ------------------------------------------------------------ */
    ...
    function setUp()
    {
        ...
        $this->_subject = new Publisher_site_pages();
    }
