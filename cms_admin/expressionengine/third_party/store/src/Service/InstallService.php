...
class InstallService extends AbstractService
{
    ...
    public function install_site($site_id)
    {
        ...
        $default_countries = require(PATH_THIRD.'store/config/countries.php');
        ...
        $default_states = require(PATH_THIRD.'store/config/states.php');
        $insert_states = array();
        ...
        $this->ee->store->config->update(array(
            'store_reporting_timezone' => config_item('default_site_timezone')
        ));
